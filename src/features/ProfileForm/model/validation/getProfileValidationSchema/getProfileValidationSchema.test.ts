import { getProfileValidationSchema } from './getProfileValidationSchema';
...
describe('getProfileValidationSchema', () => {
  test('should return profile if all fields are correct', (done) => {
    getProfileValidationSchema().validate(mockedProfile, { abortEarly: false, })
      .then(profile => {
  ...
  test('should return return error for each incorrect field', (done) => {
    ...
    getProfileValidationSchema().validate(invalidProfile, { abortEarly: false, })
      .then(() => {
